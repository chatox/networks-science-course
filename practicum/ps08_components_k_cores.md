...
[**REPORT**] Indicate in your report if there is a giant connected component, and if yes, what is its size as a percentage of the total number of nodes. Indicate if there are singleton components, and if yes, how many. Indicate if  there are non-giant non-singleton components, and if yes, how many.
...
[**REPORT**] Include a bar plot of the k-core sizes per level.
...
[**DELIVER**] Include this csv file in your .zip deliverable.
...
[**REPORT**] Include a graph with nodes colored for each k-core component, generated by Cytoscape, and including a legend or color code.
