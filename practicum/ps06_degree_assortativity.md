...
[**REPORT**] Include a drawing of this sub-graph in your report.
...
[**REPORT**] Include a plot of the degree distribution in your report, including a fitted line, plus the exponent gamma you obtained.
...
[**REPORT**] Include a plot of the degree-degree correlation plot in your report.
...
[**REPORT**] For the Internet graph, include a plot of the degree distribution (and the power law fitted to it, including the exponent gamma) and degree-degree correlation in your report.
...
[**REPORT**] For the astrophysicists graph, include a plot of the degree distribution (and the power law fitted to it, including the exponent gamma) and degree-degree correlation in your report.

# DELIVER (individually)

Deliver a zip file including your report and code.

The report should be in PDF and can have up to 4 pages, containing each of the elements marked [**REPORT**] above. For each of those elements:
